<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"F:\phpStudy\WWW\11g12\lvyou_tp5\public/../application/index\view\index\vip.html";i:1526286046;}*/ ?>
<?php
...
?>
  ...
  <div class="cont">
    ...
    <dl class="helpNav vipNav">
     <dt>我的主页</dt>
      <dd>
       ...
       <a href="vip_order">我的订单</a>
      </dd>
     <dt>账户设置</dt>
      <dd>
       <a href="vipMy">个人信息</a>
       <a href="vipPwd">密码修改</a>
       <a href="vipAdress">收货地址</a>
      </dd>
      <dt>客户服务</dt>
       <dd>
        <a href="vipExit">网站使用条款</a>
        <a href="vipTuihuo">网站免责声明</a>
   ...
   <div class="contRight">
    ...
    <div class="addList2">
     <input type="image" src="/lvyou/images/baocun.png" width="79" height="30" />
    </div><!--addList2/-->
   </div><!--address/-->
   </div><!--contRight/-->
   <div class="clears"></div>
